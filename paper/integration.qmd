...
The framework generates seven testable predictions — from the scaling profile of statistical complexity across layers, to the claim that in-context learning should fail specifically when the required regularity *type* is absent from the weight geometry. It reframes the grounding problem as a rate-distortion question with measurable parameters and characterises alignment as a projection bottleneck between the receiver's distortion measure and the narrow feedback channels available to communicate it.
