...
The framework generates eight testable predictions — from the scaling profile of statistical complexity across layers, to the claim that chain-of-thought effectiveness tracks the enrichment fraction per step rather than chain length. It reframes the grounding problem as a rate-distortion question with measurable parameters and characterises alignment as a projection bottleneck between the receiver's distortion measure and the narrow feedback channels available to communicate it.
