...
This is a living document ({{< meta version >}}). The current version, source, and revision history are available at [github.com/ddisisto/integration-framework](https://github.com/ddisisto/integration-framework).
