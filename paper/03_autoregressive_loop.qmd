...
@sec-grounding-alignment will develop what happens when the model's implicit distortion measure diverges from the receiver's — the formal structure shared by the grounding and alignment problems.
