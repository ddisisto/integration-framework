...
The measurement debate does, however, constrain how the framework's predictions should be tested. Predictions involving mutual information (@pred-ib-complement) should be tested with estimation methods robust to the issues identified above — ideally multiple methods, to ensure results are not artefacts of a particular estimator. Predictions involving statistical complexity (@pred-complexity-depth, @pred-capability-complexity) face their own estimation challenges (@sec-appendix-complexity) but are not affected by the mutual information measurement debate, since they concern a different quantity entirely.
