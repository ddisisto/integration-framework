...
The measurement debate does, however, constrain how the framework's theoretical commitments should be tested. Claims involving mutual information (the [IB complementarity](#pred-ib-complement) commitment) should be tested with estimation methods robust to the issues identified above — ideally multiple methods, to ensure results are not artefacts of a particular estimator. Claims involving statistical complexity ([complexity-depth scaling](#pred-complexity-depth), [capability-complexity correlation](#pred-capability-complexity)) face their own estimation challenges (@sec-appendix-complexity) but are not affected by the mutual information measurement debate, since they concern a different quantity entirely.
