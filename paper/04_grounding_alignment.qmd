...
@sec-training established that the training objective and data jointly determine the model's distortion measure — what it treats as worth preserving during compression. This measure is fully specified without reference to grounding, understanding, or meaning: it is whatever statistical structure in the training distribution helps predict the next token, encoded under the parameter budget available.
