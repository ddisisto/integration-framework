...
- `sec-predictions-part1` — Predictions 1–5
...
- `sec-predictions-part2` — Predictions 6–8

### Chapter 4
- `sec-projection-bottleneck` — Channel capacity as substrate-independent constraint
- `sec-vygotsky` — Inner/external speech
- `sec-fodor` — Language of Thought structural claim
- `sec-co-evolution` — Deacon and the co-evolutionary disanalogy
- `sec-levinson` — Cross-linguistic spatial cognition (hedged)
- `sec-convergence-limits` — What convergence explains and what it doesn't
- `sec-grounding-rate-distortion` — Grounding as rate-distortion question
...
- `sec-predictions-part3` — Predictions 9–10
